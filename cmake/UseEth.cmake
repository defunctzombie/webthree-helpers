function(eth_apply TARGET REQUIRED SUBMODULE)
	...
	if (${SUBMODULE} STREQUAL "ethash-cuda")
		if (ETHASHCUDA)
			eth_use(${TARGET} ${REQUIRED} Eth::ethash)
			#target_include_directories(${TARGET} SYSTEM PUBLIC ${CUDA_INCLUDE_DIRS})
			#target_link_libraries(${TARGET} ${Eth_ETHASH-CUDA_LIBRARIES})
			target_compile_definitions(${TARGET} PUBLIC ETH_ETHASHCUDA)
		endif()
	endif()
	...
	if (${SUBMODULE} STREQUAL "ethashseal")
		...
		eth_use(${TARGET} OPTIONAL Eth::ethash-cl Eth::ethash-cuda Cpuid)
	...
	if (${SUBMODULE} STREQUAL "ethereum")
		...
		if (NOT EMSCRIPTEN)
			eth_use(${TARGET} ${REQUIRED} Eth::lll Dev::p2p Dev::devcrypto)
		endif()
